...
class PageHtmlBuilder {
	 ...
	 * </p>
	 *
	 * @param NavComposer|null $navComposer <p>Use {@link \page\ui\nav\Nav} to build a suitable {@link NavComposer}.
	 * If you pass null, the default {@link NavComposer} will be used (<code>Nav::root()</code>).</p>
	 *
	 * <p>See {@link \page\ui\nav\Nav} for further information.</p>
	 *
	 * @param array|null $attrs html attributes of the outer ul
	 * @param array|null $ulAttrs html attributes of every inner ul
	 * @param array|null $liAttrs html attributes of every li
	...
	public function navigation(?NavComposer $navComposer = null, ?array $attrs = null, ?array $ulAttrs = null,
			?array $liAttrs = null, ?array $aAttrs = null, ?array $currentAAttrs = null) {
		$this->view->out($this->getNavigation($navComposer, $attrs, $ulAttrs, $liAttrs, $aAttrs, $currentAAttrs));
	}
	...
	public function getNavigation(?NavComposer $navComposer = null, ?array $attrs = null, ?array $ulAttrs = null,
		...
		return $navComposer->build($this->view, $attrs, $ulAttrs, $liAttrs, $aAttrs, $currentAAttrs);
	}
	 ...
	 *
	 * @param array|null $attrs Html attributes of the ul element.
	 * @param array|null $liAttrs Html attributes of each li element
	 * @param array|null $aAttrs
	 * @param null $divider Pass a {@link \n2n\web\ui\UiComponent} or string if a divider span element should be printed
	 * in each li element.
