...
class NavFactory {
	...
	function setCurrentAAttrs(array $currentAAttrs): static {
		$this->currentAAttrs = $currentAAttrs;
		return $this;
	}
	...
	private function buildLi(HtmlView $view, NavBranch $navBranch, int $numProcessLevels,
		...
		$aAttrs = $this->aAttrs;
		if ($infos & NavItemBuilder::INFO_CURRENT) {
			$aAttrs = HtmlUtils::mergeAttrs($aAttrs, $this->currentAAttrs, true);
		}

		$li = $this->navItemBuilder->buildLi($view, $leaf, $this->liAttrs, $aAttrs, $infos);
