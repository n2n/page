...
/**
 * <p>MurlPage creates a {@link MurlPageComposer} which can be used to build Urls to pages. It can be used like 
...
class MurlPage {
	...
	/**
	 * Creates a {@link MurlPageComposer} which points to the root page of the current page according to 
	 * {@link \page\model\PageState}. If there is no current page any root page will be used.
	 *
	 * @return \page\model\nav\murl\MurlPageComposer
	 */
	public static function root() {
		return new MurlPageComposer(NavBranchCriteria::createNamed(NavBranchCriteria::NAMED_ROOT));
	}
	
	/**
	 * Creates a {@link MurlPageComposer} which points to the current page according to 
	 * {@link \page\model\PageState}. If there is no current page any root page will be used.
	 *
	 * @return \page\model\nav\murl\MurlPageComposer
	 */
	public static function current() {
		return new MurlPageComposer(NavBranchCriteria::createNamed(NavBranchCriteria::NAMED_CURRENT));
	}
	...
	public static function home() {
		return new MurlPageComposer(NavBranchCriteria::createNamed(NavBranchCriteria::NAMED_HOME));
	}
	
	public static function subHome(string $subsystemName = null) {
		return new MurlPageComposer(NavBranchCriteria::createSubHome($subsystemName));
	}
	
	
	/**
	 * <p>Creates a {@link MurlPageComposer} which points to a page which is affiliated with the passed object.</p>
	 * 
	...
	public static function obj($obj) {
		return new MurlPageComposer(NavBranchCriteria::create($obj));
	}
	
	/**
	 * Creates a {@link MurlPageComposer} which points to a page which contains passed tags.
	 * 
	...
	public static function tag(string ...$tagNames) {
		return new MurlPageComposer(NavBranchCriteria::create(null, $tagNames));
	}
	
	/**
	 * Creates a {@link MurlPageComposer} which points to a page which is marked with passed hooks.
	 *
	...
	public static function hook(string ...$hookKeys) {
		return new MurlPageComposer(NavBranchCriteria::create(null, null, $hookKeys));
	}
}
